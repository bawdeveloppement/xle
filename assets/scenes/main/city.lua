local Camera    = require(_G.engineDir .. "baw.object.primitives.camera").Default.config
local Appart    = require(_G.assetDir .. 'prefabs.appart')
local City      = require(_G.engineDir .. 'middleclass')('City')
